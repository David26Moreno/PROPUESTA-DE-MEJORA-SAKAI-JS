...
const Crud = () => {
    ...
    const nameUsBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">nombreus</span>
                {rowData.nombreus}
            </>
        );
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Mostrado del {first} a {last} de {totalRecords} datos"
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="AGREGAR USUARIO" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <InputText id="nombreus" value={product.nombreus} onChange={(e) => onInputChange(e, 'nombreus')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.nombreus })} />
                        ...
                        <div className="field">
                            ...
                            {submitted && !product.dni && <small className="p-invalid">El DNI es requerido.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="celular">Celular</label>
                            <InputText id="celular" value={product.celular} onChange={(e) => onInputChange(e, 'celular')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.celular })} />
                            {submitted && !product.dni && <small className="p-invalid">El celular es requerido.</small>}
                        </div>
                    </Dialog>

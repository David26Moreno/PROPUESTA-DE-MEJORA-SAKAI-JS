...
const Crud = () => {
    ...
    const dateRegBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">FechaReg</span>
                {rowData.fechaReg}
            </>
        );
    };
    const dateAltBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">FechaAlt</span>
                {rowData.fechaAlt}
            </>
        );
    };
    ...
    const especialistaBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">Especialista</span>
                {rowData.especialista}
            </>
        );
    };
    const consultorioBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">Consultorio</span>
                {rowData.consultorio}
            </>
        );
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">REPORTE DE CITAS</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="consultorio" header="Consultorio" sortable body={consultorioBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                    </DataTable>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            <label htmlFor="name">FECHA DE ALTA</label>
                            <InputText id="name" value={product.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.name })} />
                            {submitted && !product.name && <small className="p-invalid">Name is required.</small>}
                        </div>
                        <div className="field">
